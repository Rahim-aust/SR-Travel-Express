            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId())
                {
                    case R.id.menu_home:
                        ...
                        Intent h = new Intent(CustomerCareActivity.this, CustomerBookingActivity.class);
                    ...
                    case R.id.menu_profile:
                        Intent p = new Intent(CustomerCareActivity.this, CustomerProfileActivity.class);
                    ...
                    case R.id.menu_Ticket_Information:
                        Intent t = new Intent(CustomerCareActivity.this, CustomerTicketDetailsActivity.class);
                    ...
                    case R.id.menu_Ticket_Cancel:
                        Intent ct = new Intent(CustomerCareActivity.this, CustomerTicketCancelActivity.class);
                        ...
                        break;
                    case R.id.menu_help:
                        Intent he = new Intent(CustomerCareActivity.this, CustomerHelpActivity.class);
                    ...
                    case R.id.menu_customer_care:
                        Intent cc = new Intent(CustomerCareActivity.this, CustomerCareActivity.class);
                    ...
                    case R.id.menu_logout:
                        Intent lg = new Intent(CustomerCareActivity.this, CustomerLoginActivity.class);
